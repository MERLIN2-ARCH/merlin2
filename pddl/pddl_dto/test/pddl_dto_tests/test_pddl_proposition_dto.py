...
class TestPddlPropositionDto(unittest.TestCase):
    ...
    def test_pddl_dto_proposition_eq_true(self):
        pddl_proposition_dto = PddlPropositionDto(
            self._robot_at, [self._rb1, self._wp1])
        result = (self.pddl_proposition_dto == pddl_proposition_dto)
        self.assertTrue(result)

    def test_pddl_dto_proposition_eq_false_bad_objects(self):
        pddl_proposition_dto = PddlPropositionDto(
            self._robot_at, [self._wp1, self._rb1])
        result = (self.pddl_proposition_dto == pddl_proposition_dto)
        self.assertFalse(result)

    def test_pddl_dto_proposition_eq_false_bad_len(self):
        pddl_proposition_dto = PddlPropositionDto(
            self._robot_at, [self._wp1])
        result = (self.pddl_proposition_dto == pddl_proposition_dto)
        self.assertFalse(result)

    def test_pddl_dto_proposition_eq_false_bad_predicate(self):
    ...
    def test_pddl_dto_proposition_eq_false_bad_instance(self):
