...
class Merlin2CheckDoorFsmAction(Merlin2FsmAction):
    ...
    def __init__(self) -> None:
        ...
        self.add_state("CHECKING_THE_DOOR", tts_state, {SUCCEED: "PREPARING_WELCOME"})

        self.add_state(
            "PREPARING_WELCOME", prepare_goal_welcome_state, {"valid": "WELCOME"}
        )

        self.add_state("WELCOME", tts_state)
    ...
    def create_conditions(self) -> List[PddlConditionEffectDto]:
        ...
        condition_1 = PddlConditionEffectDto(
            door_at, [self.__door, self.__entrance], time=PddlConditionEffectDto.AT_START
        )

        condition_2 = PddlConditionEffectDto(
            robot_at, [self.__entrance], time=PddlConditionEffectDto.AT_START
        )
    ...
    def create_effects(self) -> List[PddlConditionEffectDto]:
        ...
        effect_1 = PddlConditionEffectDto(
            door_checked, [self.__door], time=PddlConditionEffectDto.AT_END
        )
