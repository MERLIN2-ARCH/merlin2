...
from merlin2_demos.pddl import (
    door_checked,
    door_at,
    door_type,
    sound_type,
...
class Merlin2Demo3Node(Merlin2MissionNode):
    ...
    def execute_mission(self):
        ...
        door_checked_goal = PddlPropositionDto(door_checked, [self.door], is_goal=True)
        robot_at_goal = PddlPropositionDto(robot_at, [self.livingroom], is_goal=True)
