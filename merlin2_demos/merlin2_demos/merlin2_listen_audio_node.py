...
class Merlin2ListenAudio(Node):
    ...
    def __init__(self) -> None:
        ...
        self._subscription = self.create_subscription(
            String, "/sound_recognition/sound_recognition", self.sound_listened, 10
        )
    ...
    def sound_listened(self, msg):
        ...
        if not self._sound_listened_prop_old is None:
            self.__pddl_proposition_dao.delete(self._sound_listened_prop_old)

        self.sound = PddlObjectDto(sound_type, msg.data)

        sound_listened_prop = PddlPropositionDto(sound_listened, [self.sound])
